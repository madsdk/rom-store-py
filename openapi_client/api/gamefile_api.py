...
class GamefileApi:
    ...
    def filter_game_files(
        ...
        :param game_file_search_filter: (required)
        :type game_file_search_filter: GameFileSearchFilter
        :param offset:
        :type offset: int
        :param limit:
        :type limit: int
        ...
        _param = self._filter_game_files_serialize(
    ...
    @validate_call
    def filter_game_files_with_http_info(
        self,
        game_file_search_filter: GameFileSearchFilter,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
    ...
    @validate_call
    def filter_game_files_without_preload_content(
        self,
        game_file_search_filter: GameFileSearchFilter,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
    ...
    def _filter_game_files_serialize(
        self,
        ...
        if game_file_search_filter is not None:
            _body_params = game_file_search_filter
    ...
    def _get_game_files_by_game_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/gamefile/by-game/{game_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_game_files_by_platform_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/gamefile/by-platform/{platform_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
