...
class SearchApi:
    ...
    def search(
        ...
        API endpoint for complex querying for TOSEC game files. This draws in data from gamefile, game, and platform.

        :param search_filter: (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SearchResultWithLimitOffset",
    ...
    def search_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchResultWithLimitOffset]:
        """Search
